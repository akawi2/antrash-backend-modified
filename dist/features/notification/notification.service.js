...
let NotificationService = class NotificationService {
    ...
    async updateNotification(id, modifiedNotification) {
        const modifyNotification = await this.notificationModel.findOneAndUpdate({ _id: id }, modifiedNotification, { new: true });
